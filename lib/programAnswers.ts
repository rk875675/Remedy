/**
 * Program-answer apply rules.
 *
 * Editing/saving answers is unlimited. Applying them to the snapshot is split:
 *   - cheap (equipment, sessions/week): patch remaining incomplete sessions now
 *   - expensive (pain/activity/goals): queue for the next program week
 *
 * Keep in sync with supabase/functions/_shared/assignment/programAnswers.ts.
 */
