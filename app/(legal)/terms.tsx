...
export default function TermsScreen() {
  ...
  useEffect(() => {
    legalDocumentViewed({ document: 'terms', source_screen: 'legal_screen' });
  }, []);
  ...
  return (
    <SafeAreaView style={styles.container}>
      ...
      <ScrollView contentContainerStyle={styles.scrollContent} showsVerticalScrollIndicator={false}>
        ...
        <TouchableOpacity
          onPress={() => void Linking.openURL(TERMS_PUBLIC_URL)}
          activeOpacity={0.7}
          style={styles.webLinkWrap}
        >
          <Text style={styles.webLink}>{TERMS_PUBLIC_URL.replace('https://', '')}</Text>
        </TouchableOpacity>
      </ScrollView>
    </SafeAreaView>
  );
